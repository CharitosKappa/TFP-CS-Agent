...
- requiresReply: true ΜΟΝΟ αν υπάρχει ΣΑΦΕΣ, ΕΝΕΡΓΟ αίτημα ή ερώτηση που περιμένει απάντηση ΤΩΡΑ. false αν το μήνυμα είναι ουσιαστικά κλείσιμο/ευχαριστία/επιβεβαίωση (π.χ. «ευχαριστώ πολύ!», «εντάξει, όλα καλά»). ΠΡΟΣΟΧΗ: μια ευγενική/παθητική/ΥΠΟΘΕΤΙΚΗ ευχή σε ένα κατά τα άλλα μήνυμα-κλείσιμο (π.χ. «αν ποτέ έρθει ξανά stock, ενημερώστε με», «θα χαρώ να μάθω αν…», «καλή συνέχεια») ΔΕΝ είναι ενεργό αίτημα → requiresReply=false. Επίσης αν έχουμε ήδη απαντήσει στο ουσιαστικό αίτημα και ο πελάτης απλώς ευχαριστεί/κλείνει → false.`;
