...
- productColor: το χρώμα που θέλει ο πελάτης για ένα προϊόν, ΙΔΙΩΣ όταν ζητά το ΙΔΙΟ μοντέλο σε ΔΙΑΦΟΡΕΤΙΚΟ χρώμα (π.χ. «θα ήθελα το ίδιο σε πράσινο» → "πράσινο"· «same in black» → "black"). Αλλιώς παράλειψέ το.
...
- wrongRecipient: true όταν το αίτημα μάλλον μας ήρθε ΚΑΤΑ ΛΑΘΟΣ — αφορά προϊόν που ΣΑΦΩΣ δεν πουλάμε (είμαστε κατάστημα ΓΥΝΑΙΚΕΙΩΝ ΥΠΟΔΗΜΑΤΩΝ: παπούτσια/σανδάλια & σχετικά αξεσουάρ· π.χ. ηλεκτρονικά όπως «CarPlay», κινητά, οικιακές συσκευές ΔΕΝ είναι δικά μας) ή παραγγελία που προφανώς δεν είναι δική μας — δηλαδή αφορά ΑΛΛΗ εταιρεία/κατάστημα (ακόμη κι αν ο αποστολέας τυχαίνει να είναι και δικός μας πελάτης). Αλλιώς παράλειψέ το.
