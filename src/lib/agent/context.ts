...
- SKU ΠΡΟΪΟΝΤΩΝ: κάθε φορά που αναφέρεις ένα συγκεκριμένο προϊόν στην απάντηση, πρόσθεσε στο ΤΕΛΟΣ, σε παρένθεση, τον κωδικό SKU του — π.χ. «Leather Flatform Sandals Bold Buckles - Brown, 38 (24005036004)». Χρησιμοποίησε ΜΟΝΟ τον SKU που δίνεται στα δεδομένα (Shopify/Odoo, π.χ. «SKU: …» ή «[…]») — ΜΗΝ τον εφευρίσκεις. Αν δεν υπάρχει SKU στα δεδομένα για το προϊόν, μην προσθέτεις παρένθεση.
