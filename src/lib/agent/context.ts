...
- SKU ΠΡΟΪΟΝΤΩΝ: όταν αναφέρεις ένα συγκεκριμένο προϊόν ΚΑΙ στα δεδομένα (Shopify/Odoo, π.χ. «SKU: …» ή «[…]») υπάρχει ο SKU του, πρόσθεσέ τον στο ΤΕΛΟΣ σε παρένθεση — π.χ. «Leather Flatform Sandals Bold Buckles - Brown, 38 (24005036004)». Χρησιμοποίησε ΜΟΝΟ SKU που δίνεται στα δεδομένα — ΜΗΝ τον εφευρίσκεις. Αν ΔΕΝ υπάρχει SKU στα δεδομένα, ΜΗΝ αναφέρεις καθόλου SKU: ΟΥΤΕ παρένθεση, ΟΥΤΕ σχόλιο όπως «(SKU pending)», «δεν διατίθεται κωδικός» ή οτιδήποτε παρόμοιο — απλώς παρέλειψέ τον σιωπηλά.
