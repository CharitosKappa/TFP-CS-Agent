  ...
  input_schema: {
    ...
    properties: {
      ...
      follow_up_title: {
        type: "string",
        description:
          "ΜΟΝΟ όταν χρειάζεται follow-up/ανθρώπινη ενέργεια: ΠΟΛΥ σύντομη ουσία της ενέργειας (≤ 6 λέξεις, ΧΩΡΙΣ αριθμό παραγγελίας/όνομα — μπαίνουν αυτόματα), π.χ. «Απόφαση goodwill», «Έρευνα DHL», «Επιστροφή χρημάτων IBAN», «Ακύρωση παραγγελίας». ΓΡΑΨΕ ΤΟ ΠΑΝΤΑ ΣΤΑ ΕΛΛΗΝΙΚΑ — είναι ΕΣΩΤΕΡΙΚΟ πεδίο για την ελληνόφωνη ομάδα, ΑΝΕΞΑΡΤΗΤΑ από τη γλώσσα της απάντησης προς τον πελάτη. Αλλιώς παράλειψέ το.",
      },
      follow_up_details: {
        type: "string",
        description:
          "ΜΟΝΟ όταν χρειάζεται follow-up: ΑΝΑΛΥΤΙΚΑ τι πρέπει να αποφασιστεί ή να γίνει από τον συνεργάτη (εσωτερικό, ΟΧΙ προς τον πελάτη) — το ερώτημα/απόφαση, τα κρίσιμα στοιχεία, τι ζητά ο πελάτης, και τυχόν προτεινόμενες επιλογές. 1-4 σύντομες προτάσεις. ΓΡΑΨΕ ΤΟ ΠΑΝΤΑ ΣΤΑ ΕΛΛΗΝΙΚΑ — ΕΣΩΤΕΡΙΚΟ πεδίο για την ομάδα, ΑΝΕΞΑΡΤΗΤΑ από τη γλώσσα της απάντησης προς τον πελάτη.",
      },
    },
